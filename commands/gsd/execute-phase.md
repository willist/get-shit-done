...
<execution_context>
@${CLAUDE_PLUGIN_ROOT}/get-shit-done/workflows/execute-phase.md
@${CLAUDE_PLUGIN_ROOT}/get-shit-done/templates/subagent-task-prompt.md
</execution_context>
...
See `@${CLAUDE_PLUGIN_ROOT}/get-shit-done/workflows/execute-phase.md` step `checkpoint_handling` for complete details.
</checkpoint_handling>
